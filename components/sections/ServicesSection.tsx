  ...
  return (
    <section id="servicios" className="mx-auto max-w-7xl scroll-mt-32 px-6 py-24 md:py-32 lg:px-10">
      <div className="grid gap-12 lg:grid-cols-[.7fr_1.3fr]">
        <div><SectionLabel>Lo que hacemos</SectionLabel><h2 className="mt-5 font-heading text-4xl font-extrabold leading-none tracking-tight md:text-6xl">Cuatro formas de hacerte <em className="font-extrabold italic"><Mark>avanzar</Mark></em>.</h2></div>
